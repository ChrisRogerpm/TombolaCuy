                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        ...
                        <a href="#" class="navbar-search-toggle hidden-xs">
                            <i class="icon icon-inline fa fa-search"></i> <span class="hidden-sm hidden-md hidden-lg">Search</span>
                        </a>
                    </li>
                    <li class="dropdown">
                    ...
                    <li class="dropdown">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="user-name">Louis</span>
                        </a>
                        <!-- /Profile avatar -->
        ...
        <div class="sidebar">
            ...
            <div class="height100p custom-scroll">
                ...
                <ul class="nav-sidebar">
                    ...
                    <li><a href="{{route('TipoPago.Listar')}}"><i class="icon icon-inline fa fa-mail-forward"></i> <span class="title">Tipo Pago</span></a></li>
                    <li><a href="{{route('TipoApuesta.Listar')}}"><i class="icon icon-inline fa fa-mail-forward"></i> <span class="title">Tipo Apuesta</span></a></li>
            ...
            <div class="sidebar-fixed-bottom">
                ...
                <div class="btn-group-wrapper">
                    <div class="btn-group btn-group-justified" role="group">
                        ...
                        <a href="xp-lockscreen.html" class="btn btn-dark" role="button"><i class="icon icon-inline fa fa-lock"></i></a>
                        <a href="xp-login.html" class="btn btn-dark" role="button"><i class="icon icon-inline fa fa-sign-out"></i></a>
                    </div>
                </div>
