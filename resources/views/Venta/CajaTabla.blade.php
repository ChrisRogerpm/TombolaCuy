                        ...
                        <div style="width:25%;display:block" class="" >
                            <div style="display:flex;width:100%">
                                <div id="fechaServidor" style="display:flex;width:50%;border:0" >
                                        ...
                                        <div style="width:30%;text-align:right;font-size: 30px;background-color: #a5201b;box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.1), inset 0 -3px 2px rgba(0, 0, 0, 0.12), 0 5px 5px rgba(0, 0, 0, 0.4), 0 0 5px rgba(0, 0, 0, 0.4), inset 0 -15px 10px rgba(0, 0, 0, 0.25);" class="">
