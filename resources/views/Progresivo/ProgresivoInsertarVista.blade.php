                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon bg-primary text-white">MONEDA</div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon bg-primary text-white">DURACIÓN PANTALLA(SEGUNDOS)
                                    </div>
                                    <input type="text" class="form-control input-sm">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon bg-primary text-white">NRO. JUGADORES</div>
                                    <input type="text" class="form-control input-sm">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon bg-primary text-white">NRO. POZOS</div>
                                    <input type="text" class="form-control input-sm">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="custom-checkbox custom-checkbox-primary">
                                <input type="checkbox" id="cb-custom-primary">
                                <label for="cb-custom-primary">Pozo Oculto</label>
                            </div>
                            <div class="custom-checkbox custom-checkbox-primary">
                                <input type="checkbox" id="cb-custom-primary2">
                                <label for="cb-custom-primary2">Registrar Historico</label>
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-nowrap no-mb">
                                    <thead style="background-color: #D61213">
                                    <tr>
                                        <th></th>
                                        <th>
